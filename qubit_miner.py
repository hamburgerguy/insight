...
ibmqx2_result_answer = {int('1001',2): 523, int('1100',2): 263, int('0101',2): 439, int('0110',2): 522, int('0001',2): 403, int('0010',2): 493, int('1010',2): 458, int('1011',2): 429, int('0111',2): 759, int('1000',2): 535, int('0011',2): 501, int('1110',2): 469, int('1111',2): 554, int('0100',2): 374, int('1101',2): 341, int('0000',2): 555}
...
def q_grover(Oracle):
    ...
    final = int((max(answer.items(),key=operator.itemgetter(1))[0:2]),2)
